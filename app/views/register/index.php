    ...
    <!----------------------- Login Container -------------------------->
       <div class="row border rounded-5 p-3 bg-white shadow box-area">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control form-control-lg bg-light fs-6" placeholder="Email" name="email" value="">
                </div>
                <div class="input-group mb-3">
                ...
                <div class="input-group py-3">
                    <button class="btn btn-lg btn-primary w-100 fs-6" value="register" name='register' type="submit">Register</button>
                </div>
                </form>
